  ...
  <div class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
    <div class="container mx-auto px-4 mt-4 py-1 pb-16">
      <div class="flex justify-between items-center mb-3">
        ...
        <h1 class="text-xl text-warning shadow p-1 ">EDIT SERVICE</h1>
      </div>
          ...
          <div class='shadow bg-white p-7 border around mb-4'>
            <div class="space-y-3">
              <div>
                ...
                <input id="name" type="text" name="name" value="{{ old('name', $service->name) }}" placeholder="Enter name" class="w-full px-3 py-1 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200 text-sm" />
              </div>
              <div>
                <label for="description" class="text-gray-700 font-medium text-sm">Description</label>
                <textarea name="description" id="description" placeholder="Enter description" class="w-full px-3 py-1 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200 text-sm" rows="3">{{ old('description', $service->description) }}</textarea>
              </div>
