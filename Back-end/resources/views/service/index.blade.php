<x-app-layout>
    ...
    <div class="container mt-5">
        ...
        <div id="card-alert" class="cardd border-0" style="display: none;">
            <x-alert message="This is a notification alert!">
                            ...
                            <div id="notification-container" style="max-height: 400px; overflow-y: auto;">
                                @can('Service access')
                                    @foreach ($services as $service)
                                        <div class="alert border-0 alert-dark notification-card">
                                ...
                                <tr>
                                    ...
                                    <td class="table-actions d-flex justify-content-around text-center">
                                        <a class="btn btn-sm btn-info" data-bs-toggle="modal"
                                            data-bs-target="#serviceDetailsModal" data-service-image="{{ $service->image }}"
                                            data-service-title="{{ $service->name }}"
                                            data-service-description="{{ $service->description }}"
                                            data-service-category="{{ $service->category->name }}"
                                            data-service-price="{{ $service->price }}" data-service-stars="999">
                                            Details
                                        </a>
                                        @can('Service edit')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <h4 class="text-warning" id="service-title"><i class='bx bxs-star'></i> Premium Service
                                </h4>
                        ...
                        <div class="additional-info mt-3">
                            ...
                            <p id="service-additional-info">This is where additional information about the service can be
                                displayed.</p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            channel.bind('components.alert', function(data) {
            ...
            <div class="name d-flex justify-between">
                <h3 class="font-weight">${category.name}</h3>
                <h5>now</h5>
            </div>
            <div class="notification d-flex justify-between">
        ...
        <script>
            ...
            document.getElementById('search-input').addEventListener('input', function() {
                ...
                rows.forEach(row => {
                    ...
                    if (name.includes(query) || description.includes(query) || price.includes(query) || category
                        .includes(query)) {
                        row.style.display = '';
                    } else {
