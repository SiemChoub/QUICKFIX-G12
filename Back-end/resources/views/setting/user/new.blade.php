    ...
    <div class="shadow-sm rounded-md p-3 pt-0">
      <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-3">
        ...
        <div>
          ...
          <input name="email" id="email" placeholder="Enter email" class="w-full border border-gray-300 rounded-md py-1 px-2 focus:outline-none focus:ring-2 focus:ring-warning-500 focus:border-transparent" rows="2">{{ old('email') }}</input>
        </div>
        <div class="grid grid-cols-3 gap-3">
  
          <div>
            <label for="address" class="block text-gray-700 font-medium mb-1">Address</label>
            <input id="address" type="address" name="address" value="{{ old('address') }}" placeholder="Enter address number" class="w-full border border-gray-300 rounded-md py-1 px-2 focus:outline-none focus:ring-2 focus:ring-warning-500 focus:border-transparent">
          </div>
          <div>
            <label for="phone" class="block text-gray-700 font-medium mb-1">Phone</label>
            <input id="phone" type="phone" name="phone" value="{{ old('phone') }}" placeholder="Enter phone number" class="w-full border border-gray-300 rounded-md py-1 px-2 focus:outline-none focus:ring-2 focus:ring-warning-500 focus:border-transparent">
          </div>
        <div>
          ...
          <div >
            ...
            <div class="relative">
              <input id="password" type="password" name="password" value="{{ old('password') }}" placeholder="Enter password" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-warning-500 focus:border-transparent">
            </div>
          </div>
          <div >
            <label for="password_confirmation" class="block text-gray-700 font-medium mb-2">Password Comfirm</label>
            <div class="relative">
              <input id="password_confirmation" type="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Enter password_confirmation" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-warning-500 focus:border-transparent">
            </div>
          </div>
