<x-app-layout>
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            var discountId = {{ session('discountId') ?? 'null' }};
            
            if (discountId) {
                // Show your modal or popup here
    ...
    {{-- <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Discount Created</h5>
                ...
                <div class="modal-body">
                    ...
                    <p>Your discount has been created. Do you want to:</p>
                </div>
     ...
     --}}
{{-- <x-notification-index>


</x-notification-index> --}}

{{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    <x-notification :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
        {{ __('Dashboard') }}
    </x-notification>
</div> --}}
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
            <div class="container mx-auto px-6 py-8">
                <div class="product w-100 h-20 d-flex justify-content-around">
                    <div
                        class="product-card bg-white w-44 p-4 rounded-lg border-l-4 border-yellow-500 shadow-md hover:scale-110 transition-all duration-300 flex justify-between items-center">
                        ...
                        <div class="icon">
                            <i
                                class='bx bxs-category text-yellow-500 text-3xl hover:text-4xl transition-all duration-400'></i>
                        </div>
                    </div>
                    <div
                        class="product-card bg-white w-44 p-4 rounded-lg border-l-4 border-yellow-500 shadow-md flex justify-between items-center">
                        <div class="content flex flex-col items-start">
                    ...
                    <div
                        ...
                        <div class="icon">
                            <i
                                class='bx bxs-star text-yellow-500 text-3xl hover:text-4xl transition-all duration-400'></i>
                        </div>
                    </div>
                    <div
                        class=" product-card bg-white w-44 p-4 rounded-lg border-l-4 border-yellow-500 shadow-md hover:scale-110 transition-all duration-300 flex justify-between items-center">
                        ...
                        <div class="icon">
                            <i
                                class='bx bx-crown text-yellow-500 text-3xl hover:text-4xl transition-all duration-400'></i>
                        </div>
                    </div>
                    <div
                        class=" product-card bg-white w-44 p-4 rounded-lg border-l-4 border-yellow-500 shadow-md hover:scale-110 transition-all duration-300 flex justify-between items-center">
                        ...
                        <div class="icon">
                            <i
                                class='bx bx-user text-yellow-500 text-3xl hover:text-4xl transition-all duration-400'></i>
                        </div>
                    </div>
                </div>
                <div class="data p-2 pt-4 row">
                    <div class="left col-md-6">
                        ...
                        <section id="top-service">
                            <div class="top-services bg-white p-3 rounded-lg shadow">
                                ...
                                <div class="top-service-info p-3 flex flex-col space-y-2"
                                    style="height: 300px; overflow-y: scroll;">
                                    <!-- ------------------------- -->
                                    <div
                                        class="top-service-card d-flex justify-content-between items-center p-2 rounded-lg shadow-md hover:scale-105 transition-all duration-300">
                                        <div class="title relative">
                                            <p class="text-gray-800 font-medium text-sm">Air Conditioner Repair</p>
                                            <div class="d-flex items-center">
                                                <img src="https://i.pinimg.com/564x/c8/3f/05/c83f052eb98923de6edab81de2d6465b.jpg"
                                                    class=" w-9 h-9 rounded-full shadow-md z-10">
                                                <img src="https://i.pinimg.com/564x/99/7a/0f/997a0f428eb6e32f37b6ff0c7b863d0f.jpg"
                                                    class="  w-9 h-9 rounded-full shadow-md z-10"style="margin-left: -20px;object-fit: cover;">
                                                <img src="https://i.pinimg.com/564x/99/7a/0f/997a0f428eb6e32f37b6ff0c7b863d0f.jpg"
                                                    class="  w-9 h-9 rounded-full shadow-md z-10"style="margin-left: -20px;object-fit: cover;">+99
                                            </div>
                                        </div>
                                        <div class="evaluation">
                                            <i
                                                class='bx bxs-star text-yellow-500 text-xl hover:text-4xl transition-all duration-400'></i>
                                            <i
                                                class='bx bxs-star text-yellow-500 text-xl hover:text-4xl transition-all duration-400'></i>
                                            <i
                                                class='bx bxs-star text-yellow-500 text-xl hover:text-4xl transition-all duration-400'></i>
                                        ...
                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#topServiceDetail"
                                        ...
                                        <div class="title relative">
                                            ...
                                            <div class="d-flex items-center">
                                                <img src="https://i.pinimg.com/564x/c8/3f/05/c83f052eb98923de6edab81de2d6465b.jpg"
                                                    class=" w-9 h-9 rounded-full shadow-md z-10">
                                                <img src="https://i.pinimg.com/564x/99/7a/0f/997a0f428eb6e32f37b6ff0c7b863d0f.jpg"
                                                    class="  w-9 h-9 rounded-full shadow-md z-10"style="margin-left: -20px;">
                                                <img src="https://i.pinimg.com/564x/99/7a/0f/997a0f428eb6e32f37b6ff0c7b863d0f.jpg"
                                                    class="  w-9 h-9 rounded-full shadow-md z-10"style="margin-left: -20px;">+99
                                            </div>
                                        </div>
                                        <div class="evaluation">
                                            <i
                        ...
                        <div class="low-services bg-white p-3 rounded-lg shadow mt-4">
                            ...
                            <div class="low-service-info p-3 flex flex-col space-y-2"
                                style="height: 300px; overflow-y: scroll;">
                                <!-- ------------------------- -->
                                <div
                                    class="low-service-card d-flex justify-content-between items-center p-2 rounded-lg shadow-md hover:scale-105 transition-all duration-300">
                                    <div class="title relative">
                                        <p class="text-gray-800 font-medium text-sm">Air Conditioner Repair</p>
                                    ...
                                    <div class="evaluation">
                                        <button class="btn btn-outline-warning btn-sm text-center"
                                            ...
                                            data-service-title="Premium Service"
                                            data-service-description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ac diam at magna tempus volutpat."
                                            data-service-stars="0"><i class="bx bx-info-circle"></i>view more</button>
                                    </div>
                                </div>
                                <!-- ---------------------------------- -->
                                <!-- ------------------------- -->
                                <div
                                    ...
                                    <div class="evaluation">
                                        <button class="btn btn-outline-warning btn-sm " data-bs-toggle="modal"
                                            data-bs-target="#lowServiceDetail"
                                            data-service-image="https://i.pinimg.com/564x/ed/75/7f/ed757f7b67b716facd211f1733965417.jpg"
                                            data-service-title="Premium Service"
                                            data-service-description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ac diam at magna tempus volutpat."
                                            data-service-stars="0"><i class="bx bx-info-circle"></i>view more</button>
                    ...
                    <div class="right col-md-6 p-3 pt-0 flex flex-col space-y-6">
                        ...
                        <div class="top-than bg-white p-3 rounded-lg shadow " style="height:250px;">
                            ...
                            <div class="topthan-info d-flex justify-content-center">
                                ...
                                <div class="card-top p-2 shadow-sm mx-2" style="width: 8rem; height: 11rem;">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 class="card-title fw-bold mb-1"
                                            ...
                                            uuuuuuuuuuuuuuuuuuu</h5>
                                        <p class="card-text text-muted xs-font mb-2" style="font-size:12px;">99+ stars
                                        </p>
                                        ...
                                        <button class="btn btn-warning btn-sm btn-sm detail-button d-none"><small>View
                                                more</small></button>
                                    </div>
                                </div>
                                <!-- ...................................... -->
                                ...
                                <div class="card-top p-2 shadow-sm mx-2" style="width: 8rem; height: 11rem;">
                                    <div class="d-flex justify-content-center">
                                        <img src="https://i.pinimg.com/564x/68/e3/5f/68e35faf0dc4ff48db6592251a66112f.jpg"
                                            class="card rounded-circle" alt="..."
                                            style="height: 4rem; width: 4rem;object-fit: cover;">
                                    </div>
                                    <div class="card-body text-center">
                        ...
                        <div class="customer-feedback bg-white p-3 rounded-lg shadow mt-4">
                            ...
                            <div class="customer-feedback-info p-3 flex flex-col gap-3 space-y-2"
                                ...
                                <!-- ------------------------- -->
                                <div
                                    class="customer-feedback-card d-flex justify-content-between items-center p-2 rounded-lg h-12 shadow-md hover:scale-105 transition-all duration-300">
                                    <img src="https://i.pinimg.com/564x/99/7a/0f/997a0f428eb6e32f37b6ff0c7b863d0f.jpg"
                                        class="card rounded-circle" alt="..."
                                    ...
                                    <div class="title relative w-50 d-flex flex-col align-item-center pt-2">
                                        <h5 class="card-title fw-bold mb-0"
                                            style="font-size:13px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                            Chhaiya Sophorn</h5>
                                        <p class="text-gray-600 text-sm" style="font-size:10px;">Fix lerng kop mg b o
                                            jol jit😋</p>
                                    </div>
                                    <div class="evaluation">
                                        <button class="btn btn-outline-warning btn-sm text-center"
                                            ...
                                            data-service-title="Premium Service"
                                            data-service-description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ac diam at magna tempus volutpat."
                                            data-service-stars="0"><i class="bx bx-love"></i>view more</button>
                                    </div>
                                </div>
                                <!-- ---------------------------------- -->
                                <!-- ------------------------- -->
                    ...
                    <div class="data -pr-3 mt-4">
                        <iframe class="map bg-white  rounded-lg shadow" style='height:250px;'
                            ...
                            width="930" height="600" style="border:0;" allowfullscreen="" loading="lazy"
    ...
    <div class="modal fade" id="lowServiceDetail" tabindex="-1" aria-labelledby="lowServiceDetailLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p id="service-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
    ...
    <!-- ----------------low service-------------------------------- -->
    <div class="modal fade" id="topServiceDetail" tabindex="-1" aria-labelledby="topServiceDetailLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function addNotification(notification, index) {
                // Create new notification element
                const newNotification = document.createElement('div');
                newNotification.classList.add('alert', 'border-0', 'alert-dark', 'notification-card');
            ...
            <div class="notification d-flex justify-between">
                ...
                <strong>
                    <div class="btn btn-success">Confirm</div>
                    <div id="reject-${index}" class="btn btn-warning reject-btn">Reject</div>
                </strong>
            </div>
            <span class="time">5:30 PM</span>
            <span class="icon"><i class="bx bx-calendar"></i></span>
        `;
                ...
                // Prepend new notification to the container
                notificationContainer.prepend(newNotification);

                // Show only the two newest notifications
                const notifications = notificationContainer.getElementsByClassName('notification-card');
                for (let i = 0; i < notifications.length; i++) {
                    notifications[i].style.display = i < 2 ? 'block' : 'none';
                }
            ...
            setTimeout(() => {
                addNotification({
                    role_id: 'User',
                    text: 'a new notification'
                }, 100); // Example notification
            }, 1000);
        });
    </script>
